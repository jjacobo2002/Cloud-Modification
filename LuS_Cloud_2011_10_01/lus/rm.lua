		...
		if user[pID]:HasAccess(1) and reward[5] then
			...
			for tID, v in pairs(user) do
				if Get_Team(tID) == team then
					...
					InputConsole("cmsg 61,89,171 %s has recieved 500 from the Random Message Gods.", user[tID]:GetName())
				end
			end
...
rmsg[4] = function()
	InputConsole("msg RM #4: DarkOrbit is actually an online game, but I no longer play it")
end
...
rmsg[8] = function()
	InputConsole("msg RM #8: Players with scripts have more advantages...Download scripts 3.4.4.")
end
...
rmsg[10] = function()
	InputConsole("msg RM #10: Did you know that canisnip is a common donator and that he pays for the whole player of the month competition!?")
end

rmsg[11] = function()
	InputConsole("msg RM #11: Player of the month February: juninho15")
end
...
rmsg[17] = function()
	InputConsole("msg RM #17: Did you know that all commands begin with ! ?")
end
...
rmsg[20] = function()
	InputConsole("msg RM #20: Did you know flying are only for people who are afraid of running?")
end
...
rmsg[40] = function()
	InputConsole("msg RM #40: Your weak. What you need is Dr.Pepper. Drink it and you'll be like Kane.")
end
...
rmsg[45] = function()
	InputConsole("msg RM #45: Congratulations, <randomname> ! You've won the hourly prize of the PWN-GUN!")
end
...
rmsg[103] = function()
	InputConsole("msg RM #103: Sorry man, I madez you a cookie, but I eated it =(")
end
