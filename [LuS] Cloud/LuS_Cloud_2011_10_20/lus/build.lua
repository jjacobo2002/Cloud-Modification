	...
	if Message[1] == "!teslatower" or Message[1] == "!tesla" then
		if user[pID]:HasAccess(1) then
			...
			if Get_Money(pID) < price then
				...
				LuS_Attach_Scripts(bot1, { z_Set_Team=team, JFW_Base_Defence="5,800,20", teslatower="" })
				LuS_Attach_Scripts(bot2, { z_Set_Team=team, JFW_Base_Defence="5,800,20", teslatower="" })
				LuS_Attach_Scripts(bot3, { z_Set_Team=team, JFW_Base_Defence="5,800,20", teslatower="" })
				LuS_Attach_Scripts(bot4, { z_Set_Team=team, JFW_Base_Defence="5,800,20", teslatower="" })
