...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Did you know that canisnip is a common donator and that he payed for the whole player of the month competition!?", rm)
end)

table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Player of the month February 2010: juninho15", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Think about the irony involved while trying to put a character into a wall. Weird, eh?", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Did you know flying is only for people who are afraid of running?", rm)
end)

table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Did you know that tiberium can hurt you without a tib suit?", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: People who use bad language in Cloud Server get LYNCHED a few days later in real life.", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: If you attack, then dont do it alone! Get a helping hand.", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: God's great and strong but you have the chance to get stronger with !up1k. Use it, drink it!!!", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Wanna create more fairness ingame? Try your chance to join our Mod Community and create Happiness for everybody who plays Cloud.", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Put your pants on! (Lol cani?)", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: YYYYYAAAAAYYYYY! Your letting me be myself!", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Using !gethp on whitneyH is a guarantee that you'll get noobed!", rm)
end)

table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Fizzy1234 doesnt know much but what he does know, you better not challenge him!", rm)
end)

table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Now you see me, now your dead ", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: B0b is to sexy for my shirt", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: MutateMe is so awesome that you just can't denie!! (luv u muta) :p", rm)
end)

table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Did you know you could refund a mr.money, robber, darkorbit and aqollo simply by typing !refund me ?!?", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Do you know what's faster than a orphan?! SONIC! He runs faster than light and time and sound all put together! and he plays here in cloud!", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Your so amazing, remember the time, just thinking about you, gives me butterflies.", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Ever tried catching a sludge and put some salt on it? *hehe*", rm)
end)

table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Sorry man, I madez you a cookie, but I ate it =(", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Did you know that I'm mad cuz 90%% of all random messages start with DID YOU KNOW!!!!!", rm)
end)
...
table.insert(rmsg, function(rm)
	InputConsole("msg RM #%d: Lelouch Vi Britannia commands you donate all of your cash to Darkorbit!", rm)
end)
